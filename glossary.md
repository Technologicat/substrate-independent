...
**Context:** Scientific and technical etymology; the naming convention that gave us television, automobile, and *co-pter* (which see).
...
**Context:** The natural frame for *Barthes mode* (which see).
...
## co-pter
**Meaning:** The dual of flight, mapping flight into a base field. Derived by correcting the common false morpheme boundary in "helicopter": the split is *helico* + *pter* (as in the Leonardo drawing, and as in pterodactyl), not *heli* + *copter*. Since *pter* is Ancient Gratin for flying, *copter* = co-pter = the thing that is dual to flying: that which observes, coordinates, and maps flights to instructions without itself flying. Hence: airport control tower. Extension — **ptericopter**: a thing that both flies and is a co-pter, i.e., a flying flight-director. The fixed point of the co-flight functor. Unnecessarily airborne, aerodynamically questionable, but categorically inevitable. Real-world example: AWACS aircraft.
...
**Context:** AI collaboration policy; functionalism.
...
**Context:** The implicit structure of Ancient Gratin (Greek-Latin superposition) and Janus-adjacent mindset. Originally from quantum mechanics; see [Bra–ket notation](https://en.wikipedia.org/wiki/Bra%E2%80%93ket_notation).
